...
|---|---|---|---|
| suncalc.js | https://github.com/mourner/suncalc | 2.0.1 | BSD-2-Clause (suncalc.LICENSE) |
| maplibre-gl.js, maplibre-gl.css | https://github.com/maplibre/maplibre-gl-js | 5.24.0 | BSD-3-Clause (maplibre-gl.LICENSE) |
| maplibre-contour.js | https://github.com/onthegomap/maplibre-contour | 0.1.1 | BSD-3-Clause (maplibre-contour.LICENSE); includes code adapted from d3-contour (ISC) and vt-pbf (MIT) |
| pmtiles.js | https://github.com/protomaps/PMTiles | 4.5.0 | BSD-3-Clause |
| basemaps.js | https://github.com/protomaps/basemaps | 5.7.2 | BSD-3-Clause |
